            ...
            >
              ...
              <div className="relative w-[800px] h-[600px] mx-auto">
                ...
                <div className="absolute inset-0 rounded-xl overflow-hidden">
                  <motion.div
                    className="absolute inset-0 bg-[url('https://img.freepik.com/premium-vector/hand-drawn-india-map-illustration_23-2151716454.jpg?w=740')] bg-cover bg-center opacity-20"
                    initial={{ scale: 1.1 }}
                    animate={{ scale: 1 }}
